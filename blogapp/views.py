...
from .form import BlogPost #form
...
def new(request): #new.html을 띄워주는 함수 
    return render(request, 'new.html') #render()은 함수 사용하여 나온 데이터를 넘겨주고 싶을 때 사용
...
def create(request): # 입력받은 내용을 데이터베이스에 넣어주는 함수
    ...
    blog.save() 
    return redirect('/blog/'+str(blog.id)) #redirect() # render()와 인자 사용의 차이
